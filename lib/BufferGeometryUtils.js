...
export const getBufferGeometryUtils = (function () {
	...
	class BufferGeometryUtils {
		...
		static computeTangents( geometry ) {
			...
			console.warn( 'BufferGeometryUtils: .computeTangents() has been removed. Use BufferGeometry.computeTangents() instead.' );
   ...
   */
		...
		static computeMorphedAttributes( object ) {
			...
			if ( object.geometry.isBufferGeometry !== true ) {
				...
				console.error( 'BufferGeometryUtils: Geometry is not of type BufferGeometry.' );
				return null;
